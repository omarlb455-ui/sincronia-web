...
export default function Terminos() {
  return (
    <main className="min-h-screen px-6 md:px-12 py-12 max-w-3xl mx-auto">
      <Link href="/" className="text-sm text-gray-400 hover:text-gray-900">← Volver</Link>
      ...
      <article className="max-w-none text-gray-700 space-y-6 leading-relaxed">
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900">3. Plan y precios</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900">4. Responsabilidades del cliente</h2>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900">5. Limitación de responsabilidad</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900">7. Suspensión del servicio</h2>
          <p>
        ...
        <section>
          <h2 className="text-xl font-semibold text-gray-900">8. Jurisdicción</h2>
          <p>
